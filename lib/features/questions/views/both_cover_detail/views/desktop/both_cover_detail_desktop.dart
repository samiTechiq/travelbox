...
class BothCoveredDetailsDesktop extends StatelessWidget {
  const BothCoveredDetailsDesktop({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider.value(
      ...
      builder: (context, child) {
        return const BothCoveredDetailsDesktopContent();
      },
    );
  }
}

class BothCoveredDetailsDesktopContent extends StatefulWidget {
  const BothCoveredDetailsDesktopContent({
    super.key,
  });

  @override
  State<BothCoveredDetailsDesktopContent> createState() =>
      _BothCoverDetailsDesktopContentState();
}

class _BothCoverDetailsDesktopContentState
    extends State<BothCoveredDetailsDesktopContent> {
