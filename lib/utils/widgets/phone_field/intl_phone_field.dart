      ...
      child: TextFormField(
        ...
        decoration: widget.decoration.copyWith(
          ...
          contentPadding: EdgeInsets.symmetric(
              vertical: MediaQuery.of(context).size.width < 520 ? 30 : 15),
        ),
        style: widget.style,
        onSaved: (value) {
          widget.onSaved?.call(
                ...
                if (widget.showCountryFlag) ...[
                  ClipRRect(
                    ...
                    child: Image.asset(
                      ...
                      width:
                          MediaQuery.of(context).size.width > 520 ? 21.w : 21.w,
                      height:
                          MediaQuery.of(context).size.width > 520 ? 21.h : 21.h,
                      fit: BoxFit.cover,
                    ),
                  ),
                  SizedBox(
                      width: MediaQuery.of(context).size.width < 520 ? 4.w : 4),
                ],
                FittedBox(
                  child: Text(
