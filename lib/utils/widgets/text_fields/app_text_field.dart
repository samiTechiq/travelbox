...
import 'package:travelbox/utils/extensions/text_style_ext.dart';
...
class GenericTextField extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ResponsiveLayout(
      mobileLayout: GenericTextFieldMobile(
      ...
      desktopLayout: GenericTextFieldDesktop(
        borderColor: borderColor,
        focusedBorder: focusedBorder,
        fillColor: fillColor,
        requiredSpanColor: requiredSpanColor,
...
class GenericTextFieldMobile extends StatelessWidget {
  final Color? borderColor,
      focusedBorder,
      fillColor,
      requiredSpanColor,
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(
            height: height != null ? (height! + errorStyle.heightByStyle) : height,
            width: width,
            child: TextFormField(
              onChanged: onChange,
              controller: controller,
              ...
              decoration: decoration ??
                  InputDecoration(
                    ...
                    prefixIcon: Padding(
                      padding: EdgeInsetsDirectional.only(
                        start: useZeroPrefixPadding ? 0.w : 15.w,
...
class GenericTextFieldDesktop extends StatelessWidget {
  final Color? borderColor,
      focusedBorder,
      fillColor,
      requiredSpanColor,
              ...
              decoration: decoration ??
                  InputDecoration(
                    ...
                    prefixIcon: Padding(
                      padding: EdgeInsetsDirectional.only(
                        start: useZeroPrefixPadding ? 0.w : 15.w,
                        end: useZeroPrefixPadding ? 15.w : 0.w,
                      ),
                      child: Row(
                        mainAxisSize: MainAxisSize.min,
                        mainAxisAlignment: MainAxisAlignment.start,
